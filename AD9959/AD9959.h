...
#define AD9959_CS_1     DL_GPIO_setPins(AD9959_CS_PORT,AD9959_CS_PIN)
#define AD9959_SCK_1    DL_GPIO_setPins(AD9959_SCK_PORT,AD9959_SCK_PIN)
#define AD9959_PDC_1    DL_GPIO_setPins(AD9959_PDC_PORT,AD9959_PDC_PIN)
#define AD9959_RST_1    DL_GPIO_setPins(AD9959_RST_PORT,AD9959_RST_PIN)
#define AD9959_UP_1     DL_GPIO_setPins(AD9959_UP_PORT,AD9959_UP_PIN)
#define AD9959_P0_1     DL_GPIO_setPins(AD9959_P0_PORT,AD9959_P0_PIN)
#define AD9959_P1_1     DL_GPIO_setPins(AD9959_P1_PORT,AD9959_P1_PIN)
#define AD9959_P2_1     DL_GPIO_setPins(AD9959_P2_PORT,AD9959_P2_PIN)
#define AD9959_P3_1     DL_GPIO_setPins(AD9959_P3_PORT,AD9959_P3_PIN)
#define AD9959_SD0_1    DL_GPIO_setPins(AD9959_SD0_PORT,AD9959_SD0_PIN)
#define AD9959_SD1_1    DL_GPIO_setPins(AD9959_SD1_PORT,AD9959_SD1_PIN)
#define AD9959_SD2_1    DL_GPIO_setPins(AD9959_SD2_PORT,AD9959_SD2_PIN)
#define AD9959_SD3_1    DL_GPIO_setPins(AD9959_SD3_PORT,AD9959_SD3_PIN)

#define AD9959_CS_0     DL_GPIO_clearPins(AD9959_CS_PORT,AD9959_CS_PIN)
#define AD9959_SCK_0    DL_GPIO_clearPins(AD9959_SCK_PORT,AD9959_SCK_PIN)
#define AD9959_PDC_0    DL_GPIO_clearPins(AD9959_PDC_PORT,AD9959_PDC_PIN)
#define AD9959_RST_0    DL_GPIO_clearPins(AD9959_RST_PORT,AD9959_RST_PIN)
#define AD9959_UP_0     DL_GPIO_clearPins(AD9959_UP_PORT,AD9959_UP_PIN)
#define AD9959_P0_0     DL_GPIO_clearPins(AD9959_P0_PORT,AD9959_P0_PIN)
#define AD9959_P1_0     DL_GPIO_clearPins(AD9959_P1_PORT,AD9959_P1_PIN)
#define AD9959_P2_0     DL_GPIO_clearPins(AD9959_P2_PORT,AD9959_P2_PIN)
#define AD9959_P3_0     DL_GPIO_clearPins(AD9959_P3_PORT,AD9959_P3_PIN)
#define AD9959_SD0_0    DL_GPIO_clearPins(AD9959_SD0_PORT,AD9959_SD0_PIN)
#define AD9959_SD1_0    DL_GPIO_clearPins(AD9959_SD1_PORT,AD9959_SD1_PIN)
#define AD9959_SD2_0    DL_GPIO_clearPins(AD9959_SD2_PORT,AD9959_SD2_PIN)
#define AD9959_SD3_0    DL_GPIO_clearPins(AD9959_SD3_PORT,AD9959_SD3_PIN)
...
void AD9959_Set_Phase(uint8_t Channel,float Phase);//写相位
/****************************************************************************/
