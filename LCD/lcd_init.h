...
#define LCD_SCLK_Clr() DL_GPIO_clearPins(GPIO_LCD_PORT,GPIO_LCD_PIN_SCLK_PIN)//SCL=SCLK
#define LCD_SCLK_Set() DL_GPIO_setPins(GPIO_LCD_PORT,GPIO_LCD_PIN_SCLK_PIN)

#define LCD_MOSI_Clr() DL_GPIO_clearPins(GPIO_LCD_PORT,GPIO_LCD_PIN_MOSI_PIN)//SDA=MOSI
#define LCD_MOSI_Set() DL_GPIO_setPins(GPIO_LCD_PORT,GPIO_LCD_PIN_MOSI_PIN)
